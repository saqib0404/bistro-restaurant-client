                ...
                >
                    ...
                    <div className="card-body">
                        ...
                        <div className="card-actions justify-center mt-2">
                            <button className="btn btn-lg border-t-0 border-r-0 border-l-0 duration-200 hover:bg-[#111827] text-[#BB8406] border-b-2 border-[#BB8406] rounded-lg">ADD TO CART</button>
                        </div>
                    </div>
                </div>)
            }
